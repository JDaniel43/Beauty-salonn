...
export const Header = ({
	...
	return (
		<header className='flex justify-around bg-rose-300 shadow-md py-4 px-4 h-20 sm:px-10 font-[sans-serif] mb-2 fixed top-0 left-0 right-0 z-20'>
			<div className='flex flex-wrap items-center'>
				<div className='flex text-center'>
					<a
						className="items-center text-4xl font-serif text-white p-2 hover:text-black hover:rounded-full hover:bg-neutral-100"
						href="http://localhost:3000/loveMe"
					>
						NAILS STORE
					</a>
					<svg
						xmlns="http://www.w3.org/2000/svg"
						className="h-6 w-6 text-gray-100 self-center"
						width="24"
						height="24"
						viewBox="0 0 24 24"
						strokeWidth="2"
